                ...
                {projects.map(item => {
                    return(
                        <Card className="text-center center education-card">
                            ...
                            <Card.Img variant="top" src={item.src} style={{width: '200px', margin: '16px'}}/>
                            <Card.Body>
                                <Card.Text>
                                    {item.description}
                                    <br/>
...
class Project {
    constructor(name = '', description='', link='', src= '') {
        this.name = name;
        this.link = link;
